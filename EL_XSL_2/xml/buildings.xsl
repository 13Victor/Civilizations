                            ...
                            <div class="back purple" style="border: 10px solid #624180;">
                                ...
                                <div class="table2">
                                    ...
                                    <table style="">
                                        <thead>
                                            <tr>
                                                <th style="width: 25%; border: 3px solid #624180;"><img src="../img/steak.png" alt="steak"/></th>
                                                <th style="width: 25%"><img src="../img/wood.png" alt="wood"/></th>
                                                <th style="width: 25%"><img src="../img/iron.png" alt="iron"/></th>
                                                <th style="width: 25%"><img src="../img/mana.png" alt="mana"/></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
